...
@section('content')
    <div class="position-relative w-full">
        <div id="content1" class="position-absolute top-0 left-0 w-full" style="transition: opacity 1s; opacity: 0">
        ...
        <div id="content2" class="position-absolute top-0 left-0" style="transition: opacity 1s; opacity: 0">
            heel
        </div>

        <div id="content3" class="position-absolute top-0 left-0" style="transition: opacity 1s; opacity: 0">
            hiil
        </div>
    </div>
@endsection
