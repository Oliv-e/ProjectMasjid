...
<div>
    <div class="py-12 flex flex-col w-full gap-2">
        <div class="max-w-7xl w-full flex justify-between mx-auto sm:px-6 lg:px-8">
            ...
            <a wire:click="new()">Buat <i class="bi bi-plus rounded-lg bg-slate-900 hover:bg-slate-600 text-white px-4 py-2 mr-2"></i></a
        </div>
    </div>
                    ...
                    <div class="bg-blue-200 rounded-xl">
                        ...
                        <div class="card p-3 ">
                            ...
                            <div class="flex flex-col py-2 px-8">
                                ...
                                <span>Status di tampilkan {!! $item->display == 'true' ? '<span class="text-green-500">Ditampilkan</span>' : '<span class="text-red-500">tidak Ditampilkan</span>' !!}</span>
